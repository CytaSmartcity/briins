        ...
        <MapView
          ...
          >
            ...
            <MapView.Marker onPress={this._onget}
              ...
              pinColor={'#008000'}
            />
            <MapView.Marker onPress={() => {this.DirectionsPm1,navigate('Main', {screen: payments})}}
           ...
           <MapView.Marker onPress={this.DirectionsPm2}
            ...
            />
              ...
              <MapView.Marker onPress={this.DirectionsCyta}
              coordinate= {this.state.cyta}  title={"Cyta"}
              description={"Available:0/1"}
              pinColor={'#ff0000'}
            />
        </MapView>
